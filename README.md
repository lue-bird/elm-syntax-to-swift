...
-   not supported are
    ...
    -   `elm/file`, `elm/http`, `elm/browser`, `elm-explorations/markdown`, `elm-explorations/webgl`, `elm-explorations/benchmark` (for the moment also `elm/virtual-dom` and `elm/random`)
