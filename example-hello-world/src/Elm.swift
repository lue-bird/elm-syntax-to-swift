...
public static func Tuple_second<a, b>
    (generated_0:
        ((a
        , b
        ))
...
public static func Tuple_pair<a, b>
    (generated_0: a)
    -> @Sendable (b) ->
        ((a
       , b
...
public static func Tuple_mapSecond<a, b, y>
    (generated_0: @Sendable @escaping (b) -> y)
    -> @Sendable (((a
        , b
        ))
       ) ->
...
public static func Tuple_mapFirst<a, b, x>
    (generated_0: @Sendable @escaping (a) -> x)
    -> @Sendable (((a
        , b
        ))
       ) ->
...
public static func Tuple_mapBoth<a, b, x, y>
    (generated_0: @Sendable @escaping (a) -> x)
    -> @Sendable (@Sendable @escaping (b) -> y) ->
        ((a
       , b
       )) ->
        ((x
    ...
    return
        { (generated_1: @Sendable @escaping (b) -> y) in
            { (generated_2:
                ((a
                , b
                ))
...
public static func Tuple_first<a, b>
    (generated_0:
        ((a
        , b
        ))
...
public static func Hello_greet (generated_0: String) -> String {
