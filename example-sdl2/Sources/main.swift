...
let windowProperties = Elm.Run_initWindow
var window: OpaquePointer?
var renderer: OpaquePointer?
SDL_CreateWindowAndRenderer(
    Int32(windowProperties.windowWidth),
    Int32(windowProperties.windowHeight),
    SDL_WINDOW_RESIZABLE.rawValue,
    &window,
    &renderer
)
SDL_SetWindowTitle(window, windowProperties.title)
